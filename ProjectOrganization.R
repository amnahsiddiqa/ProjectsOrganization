...
# use hex_digits to generate random string
 ...
 #synctoSynapse jo already folders and projects jhain un k ids use ker k to create ker k update kerta hai 
  ...
  ## Checked that If i add more data to these files 
  it will create new versions but add the data and create new data directories itself so no problems
  
  synExtra::synStoreMany( "/Users/siddia/Desktop/SynapseTestProject", parent="syn24215009",activity = NULL)
